...
You can also raise any issues you have along the way in the `Federated Sidechains GitHub repository <https://github.com/stratisproject/FederatedSidechains>`_. Please apply the `sidechains` label to any issues that are specific to sidechains.
