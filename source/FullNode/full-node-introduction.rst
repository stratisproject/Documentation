...
The Stratis Full Node is the backbone of the Stratis Platform. It implements the both the STRAT and BTC protocol and maintains an up-to-date copy of the STRAT and BTC blockchains. Because of this, Full Nodes can:
...
The audience for this document is anyone who get involved with further developing the capabilities of the Full Node. Here are two reasons for getting involved:

1.	You want to contribute to ongoing development work on the Full Node project.
2.	You want to fork the source code and adapt for your own project. For example, you might want to add a new feature or modify the block size.
...
The purpose of this document is to provide a high-level overview of the Full Node, so you can gain an idea of how the components work together. It does not touch on individual classes.
