...
.. code:: bash
   ...
   sudo wget -O SNode.zip https://github.com/stratisproject/StratisFullNode/releases/download/latest/Stratis.StraxD-linux-arm64.zip
StraxFullNode for 32-bit
========================

.. code:: bash

   sudo wget -O SNode.zip https://github.com/stratisproject/StratisFullNode/releases/download/latest/Stratis.StraxD-linux-arm.zip
