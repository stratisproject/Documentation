...
You can also raise any issues you have along the way in the `Stratis Full Node github repository <https://github.com/stratisproject/StratisBitcoinFullNode/tree/sc-alpha>`_. Please apply the `smart-contracts` label to any issues that are specific to smart contracts.
